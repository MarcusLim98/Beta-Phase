  ...
  void Update() {
    ...
    //}
        ...
        if (flashing)
        {
            ...
            if (timer <= 1.5f)
            {
                outlineColor.a += 1f * Time.deltaTime;
                //outlineColor = Color.Lerp(Color.white, Color.black, Mathf.PingPong(Time.time, 1));
            }
            else if (timer > 1.5f)
            {
                outlineColor.a -= 1f * Time.deltaTime;
                //outlineColor = Color.Lerp(Color.black, Color.white, Mathf.PingPong(Time.time, 1));
                if (timer > 3f)
                {
                    timer = 0f;
                }
